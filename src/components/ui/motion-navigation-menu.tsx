...
function MotionNavigationMenuList({
  ...
  return (
    <Highlight
      ...
      hover
      className={cn(
        "bg-[var(--foreground)]/[0.06] rounded-md pointer-events-none",
        highlightClassName,
      )}
      style={{ zIndex: -1 }}
...
const motionNavigationMenuTriggerStyle = cva(
  "group inline-flex h-9 w-max items-center justify-center rounded-md bg-transparent px-4 py-2 text-sm font-medium hover:text-[var(--primary)] focus:text-[var(--primary)] disabled:pointer-events-none disabled:opacity-50 data-[state=open]:text-[var(--primary)] outline-none transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--primary)]",
);
  ...
  return (
    <HighlightItem asChild>
      ...
      >
        ...
        >
          <CaretDown className="size-3.5" weight="bold" aria-hidden="true" />
        </motion.span>
      </button>
    </HighlightItem>
  );
    ...
    <AnimatePresence initial={false} custom={context.direction}>
      {isOpen && (
        <motion.div
          ...
          className={cn(
            "bg-[var(--panel)]/95 text-[var(--foreground)] absolute top-full left-0 z-50 mt-1.5 rounded-md border border-[var(--border)] p-2 pr-2.5 shadow-[0_12px_40px_rgba(0,0,0,0.18)]",
            className,
          )}
        >
...
function MotionNavigationMenuContentInner({
  ...
  return (
    <Highlight
      ...
      hover
      className={cn(
        "bg-[var(--foreground)]/[0.05] rounded-sm pointer-events-none",
        highlightClassName,
      )}
      style={{ zIndex: -1 }}
      containerClassName="relative"
  ...
  return (
    ...
    >
      <motion.div
        ...
        transition={context?.spring}
        className={cn(
          "bg-[var(--panel)] text-[var(--foreground)] relative mt-1.5 overflow-hidden rounded-md border border-[var(--border)] shadow-[0_12px_40px_rgba(0,0,0,0.18)] backdrop-blur-md",
          className,
        )}
      >
        <AnimatePresence
  ...
  return (
    <HighlightItem asChild>
      <a
        ...
        className={cn(
          "data-[active=true]:text-[var(--primary)] hover:text-[var(--primary)] focus:text-[var(--primary)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--primary)] [&_svg:not([class*='text-'])]:text-[var(--muted)] flex flex-col gap-1 rounded-sm p-2 text-sm transition-colors outline-none [&_svg:not([class*='size-'])]:size-4",
          className,
        )}
        {...props}
      />
