...
export const mockProducts: Product[] = [
  ...
  },
  {
    ...
    name: "EXTREVA ASE Accelerated Solvent Extractor",
    category: "Preparación de muestras",
    filters: ["Marcas", "Preparación de muestras", "Equipamiento analítico"],
    description: "Sistema automatizado de extracción por solvente acelerado para muestras sólidas y semisólidas, con extracción y concentración walk-away de muestra a vial.",
    features: [
      "Extrae y concentra muestras automáticamente en una operación continua, con actualización a evaporación disponible para sistemas existentes.",
      "Procesa hasta cuatro muestras en paralelo y hasta 16 muestras en un lote analítico sin supervisión.",
      "La extracción asistida por gas dinámico puede reducir el consumo de solvente hasta en 50%.",
      "Reduce el trasfondo de PFAS y es aplicable a flujos como US EPA Method 1633A.",
      "Permite hasta seis solventes, incluido solvente de lavado entre métodos, y trazabilidad con lector de código de barras 2D.",
    ],
    imageUrl: "/productos/thermo-extreva-ase/portada.png",
    tags: ["Thermo Scientific", "EXTREVA ASE", "preparación de muestras", "extracción por solvente", "PFAS", "evaporación", "Ambiental"],
    detail: {
      brand: "Thermo Scientific",
      model: "EXTREVA ASE",
      fullTitle: "EXTREVA ASE Accelerated Solvent Extractor",
      subtitle: "Extracción acelerada por solvente con automatización walk-away para integrar extracción, limpieza in-cell y concentración en una sola operación.",
      highlights: ["Hasta 4 muestras en paralelo", "Hasta 16 muestras por lote", "40–200 °C", "Reducción de solvente hasta 50%"],
      advantages: [
        "Flujo automatizado desde muestra a vial, con extracción, limpieza in-cell y evaporación según configuración.",
        "Extracción hasta tres veces más rápida que métodos principales de la industria, según el fabricante.",
        "Componentes reducidos en PFAS para resultados más limpios y confiables en análisis de trazas.",
        "Seguimiento de parámetros y muestras mediante lectura de código de barras 2D con marca temporal.",
      ],
      purchaseConfigurationsTitle: "Configuraciones de compra",
      purchaseConfigurations: [
        { catalogCode: "B51004594", configuration: "EXTREVA ASE System: solo extractor para extracción de muestra y análisis PFAS." },
        { catalogCode: "B51004598", configuration: "EXTREVA ASE: extracción y evaporación para extracción y concentración de muestra." },
      ],
      technicalParameters: [
        { leftParameter: "Fluidos de extracción", leftValue: "Amplia gama de solventes orgánicos y acuosos; no compatible con ácidos ni bases", rightParameter: "Aplicado a", rightValue: "Extracción de muestra y análisis PFAS" },
        { leftParameter: "Frecuencia eléctrica", leftValue: "50/60 Hz", rightParameter: "Voltaje", rightValue: "110/220 V" },
        { leftParameter: "Requisitos neumáticos", leftValue: "Aire a 150–450 psi; nitrógeno a 400 ± 50 psi", rightParameter: "Consumo de energía", rightValue: "1700 W" },
        { leftParameter: "Presión", leftValue: "180–350 psi", rightParameter: "Flujo de bomba", rightValue: "Hasta 32 mL/min" },
        { leftParameter: "Control de temperatura", leftValue: "Extracción de 40 a 200 °C", rightParameter: "Peso", rightValue: "155 kg" },
        { leftParameter: "Bandeja de celdas", leftValue: "16 celdas + 1 de enjuague", rightParameter: "Tipo", rightValue: "Extractor de solvente acelerado" },
        { leftParameter: "Dimensiones (profundidad × ancho × alto)", leftValue: "65,2 × 100 × 88,6 cm", rightParameter: "Evaporación", rightValue: "Hasta cuatro canales; a sequedad o volumen fijo de 0,3–1,4 mL ± 0,1 mL" },
      ],
      detailBlocks: [
        { title: "Preparación de muestra todo en uno", tone: "green", items: ["Realiza extracción de muestra o extracción con limpieza in-cell y evaporación en una operación continua sin intervención entre procesos.", "La configuración de extracción puede actualizarse a evaporación para extender las capacidades del sistema instalado.", "La entrega asistida por gas combina nitrógeno y solventes orgánicos o acuosos a temperatura y presión elevadas para reducir el consumo de solvente."] },
        { title: "Capacidad y trazabilidad", tone: "green", items: ["Extrae y concentra hasta cuatro muestras en paralelo; permite extracción y evaporación sin supervisión de hasta 16 muestras en un lote analítico.", "Celdas de acero inoxidable de 1, 5, 10, 22, 34, 66 y 100 mL, compatibles con celdas Dionex ASE 150/350.", "El lector de código de barras 2D registra con marca temporal la información de cada muestra y sus parámetros. QUIKRUN acelera el inicio de secuencias."] },
        { title: "PFAS y análisis ambiental", tone: "green", items: ["Los componentes reducidos en PFAS ayudan a minimizar el trasfondo para resultados más limpios y confiables.", "La ficha de especificaciones declara que el sistema cumple los requisitos del US EPA Method 1633A para extracción y análisis de PFAS.", "La nota de aplicación incluida documenta una preparación automatizada de PFAS en suelos para un flujo relacionado con el sector Ambiental."] },
        { title: "Requisitos de instalación", tone: "yellow", items: ["Nitrógeno de 99,99% de pureza, con entrega mínima de 350 psi/25 bar y regulador compatible. Aire opcional de 99,99% con entrega mínima de 150 psi/10 bar.", "Alimentación: 220–240 Vac monofásica, 10 A, 50/60 Hz con tierra para instrumento y periféricos; o 100–120 Vac monofásica, 20 A, 50/60 Hz con tierra.", "Banco capaz de soportar el sistema, ancho mínimo de 80 cm y largo de 120 cm para unidad independiente; 50 cm de espacio posterior para circulación de aire, gases y ventilación.", "Se requiere uno o dos sistemas de extracción de techo de 100 mm de diámetro, con flujo total mínimo de 300 m³/h. Confirme la instalación completa con nuestro equipo técnico."] },
        { title: "Actualizaciones para sistemas existentes", tone: "yellow", items: ["¿Ya tiene un EXTREVA? Consulte por actualización.", "22184-60102: kit de actualización de evaporación, requerido para pasar a la versión de extracción y evaporación.", "B51004603: kit de actualización para análisis PFAS. Estos kits no son configuraciones de compra de equipo nuevo."] },
      ],
      specificationNotes: [{ title: "Configuraciones y actualizaciones", items: ["B51004594 y B51004598 son las configuraciones de compra para un equipo nuevo. Los kits 22184-60102 y B51004603 se ofrecen por separado para un EXTREVA ya instalado.", "La configuración solo extracción pesa 155 kg; la configuración de extracción y evaporación pesa 169 kg según la ficha técnica del fabricante."] }],
      descriptionImages: [
        { src: "/productos/thermo-extreva-ase/vista-frontal.png", alt: "Vista frontal del EXTREVA ASE", title: "Vista frontal del instrumento", caption: "Vista del EXTREVA ASE proporcionada por el fabricante." },
        { src: "/productos/thermo-extreva-ase/vista-lateral.png", alt: "Vista lateral del EXTREVA ASE", title: "Vista lateral del instrumento", caption: "Vista del EXTREVA ASE proporcionada por el fabricante." },
        { src: "/productos/thermo-extreva-ase/vista-posterior.png", alt: "Vista posterior del EXTREVA ASE", title: "Vista posterior del instrumento", caption: "Vista del EXTREVA ASE proporcionada por el fabricante." },
      ],
      complianceNotes: [{ title: "Uso previsto", text: "Solo para uso en investigación. No indicado para procedimientos de diagnóstico." }],
      applicationNotes: [
        { label: "PFAS en suelos", text: "La nota de aplicación AN002750 documenta un método semiautomatizado para PFAS en suelos, orientado a los requisitos de desempeño de US EPA Method 1633A." },
        { label: "Sector Ambiental", text: "La automatización de extracción y limpieza reduce manejo manual y el potencial de contaminación en flujos ambientales de PFAS." },
        { label: "Muestras sólidas y semisólidas", text: "La extracción acelerada por solvente está diseñada para extraer compuestos orgánicos de muestras sólidas y semisólidas." },
        { label: "Seguridad alimentaria", text: "La ficha técnica identifica seguridad alimentaria entre las áreas de aplicación del sistema." },
      ],
    },
  },
  {
  ...
  {
    id: "thermo-orbitrap-exploris-gc",
    slug: "thermo-orbitrap-exploris-gc",
    name: "Orbitrap Exploris GC Mass Spectrometer",
    category: "Espectrometría de masa",
    filters: ["Marcas", "Espectrometría de masa", "Equipamiento analítico"],
    description: "Espectrómetro de masa GC-MS de alta resolución para cuantificación, tamizaje y perfilado de muestras, diseñado para resultados exactos y alta productividad analítica.",
    features: [
      "Datos de escaneo completo de alta resolución y masa exacta para flujos cuantitativos, de tamizaje y descubrimiento.",
      "Identificación multipunto mediante coincidencia espectral, patrón isotópico, índices de retención y múltiples iones de confirmación.",
      "Dos niveles de resolución: hasta 30.000 o 60.000 a m/z 200, con o sin capacidad MS/MS.",
      "Configuración simple, plantillas de método integradas e informática para facilitar el uso por distintos perfiles de usuario.",
    ],
    imageUrl: "/productos/thermo-orbitrap-exploris-gc/portada.png",
    tags: ["Thermo Scientific", "Orbitrap Exploris GC", "GC-MS", "GC-MS/MS", "HRAM", "tamizaje", "Alimentos"],
    detail: {
      brand: "Thermo Scientific",
      model: "Orbitrap Exploris GC",
      fullTitle: "Orbitrap Exploris GC Mass Spectrometer",
      subtitle: "GC-MS de alta resolución y masa exacta para ampliar el alcance de análisis, consolidar métodos y entregar resultados consistentes en matrices complejas.",
      highlights: ["Resolución hasta 60.000 a m/z 200", "Escaneo hasta 40 Hz", "Rango de masa 30–3000 m/z", "MS/MS opcional y actualizable"],
      advantages: [
        "Escaneo completo HRAM para cuantificación, tamizaje, descubrimiento y análisis retrospectivo desde una misma inyección.",
        "Identificación de compuestos en múltiples puntos para acelerar la revisión y reforzar la confianza en los resultados.",
        "Capacidad MS/MS configurable desde la compra o agregable posteriormente como actualización documentada.",
        "Fuentes ExtractaBrite EI y CI, con cambio de fuente y columna sin romper el vacío.",
      ],
      purchaseConfigurationsTitle: "Configuraciones de compra",
      purchaseConfigurations: [
        { catalogCode: "BRE725540", configuration: "Orbitrap GC-MS: resolución hasta 30.000 a m/z 200, sin capacidad MS/MS." },
        { catalogCode: "BRE725541", configuration: "Orbitrap GC-MS: resolución hasta 60.000 a m/z 200, sin capacidad MS/MS." },
        { catalogCode: "BRE725542", configuration: "Orbitrap GC-MS/MS System: resolución hasta 30.000 a m/z 200, con capacidad MS/MS." },
        { catalogCode: "BRE725543", configuration: "Orbitrap GC-MS/MS System: resolución hasta 60.000 a m/z 200, con capacidad MS/MS." },
      ],
      technicalParameters: [
        { leftParameter: "Rango dinámico", leftValue: ">5000 en un solo espectro Orbitrap; >10⁶ analítico", rightParameter: "Tipo", rightValue: "Orbitrap GC-MS" },
        { leftParameter: "Exactitud de masa", leftValue: "Externa <3 ppm RMS/24 h; interna <1 ppm RMS/24 h", rightParameter: "Velocidad de escaneo", rightValue: "Hasta 40 Hz a resolución 7500, m/z 200" },
        { leftParameter: "Rango de masa", leftValue: "30 a 3000 m/z", rightParameter: "Resolución", rightValue: "Hasta 30.000 a m/z 200; 60.000 en configuración superior" },
        { leftParameter: "Cambio de polaridad", leftValue: "Ciclo Full Scan <700 ms; ciclo tSIM <600 ms a resolución 60.000", rightParameter: "Multiplexado", rightValue: "Hasta 20 precursores por escaneo" },
        { leftParameter: "Requisitos — alimentación", leftValue: "2 × 208–240 Vac monofásico, 15 A, 50/60 Hz, con tierra; 208–240 Vac monofásico, 15 A, 50/60 Hz para sistema de datos", rightParameter: "Requisitos — dimensiones", rightValue: "954 × 1036 × 703 mm (ancho × profundidad × alto)" },
        { leftParameter: "Requisitos — peso", leftValue: "156 kg, incluido GC y un inyector; sin sistema de datos, bombas ni opciones", rightParameter: "Requisitos — calor y ambiente", rightValue: "Promedio 3440 W; 18–27 °C y humedad relativa 20–80% sin condensación" },
      ],
      detailBlocks: [
        { title: "Resultados cuantitativos de alta confianza", tone: "green", items: ["El escaneo completo de alta resolución y masa exacta apoya flujos cuantitativos, de tamizaje y descubrimiento.", "La coincidencia espectral, patrones isotópicos, índices de retención y múltiples iones de confirmación apoyan la identificación multipunto.", "La revisión y el análisis retrospectivo de los datos HRAM permiten responder nuevas preguntas sin repetir la inyección."] },
        { title: "Flexibilidad para evolucionar", tone: "green", items: ["Seleccione 30.000 o 60.000 de poder de resolución de masa a m/z 200 según el flujo analítico.", "Elija una configuración GC-MS o GC-MS/MS; la capacidad MS/MS puede incorporarse al comprar o agregarse más adelante.", "La opción MS/MS incluye funciones tMS2 y adquisiciones dependientes de datos, con fragmentación HCD."] },
        { title: "Operación y tiempo de actividad", tone: "green", items: ["Fuentes ExtractaBrite EI y CI incluidas, con adquisición de baja energía VeV hasta 8 eV.", "La tecnología NeverVent permite retirar la fuente o intercambiar a CI en menos de dos minutos y cambiar la columna sin romper el vacío.", "El editor de métodos ofrece plantillas específicas, parámetros automáticos, ayuda contextual y edición mediante arrastrar y soltar."] },
        { title: "Requisitos de instalación", tone: "yellow", items: ["Alimentación del instrumento y bomba de vacío de fuente: 2 × 208–240 Vac monofásico, 15 A, 50/60 Hz, con tierra. Sistema de datos: 208–240 Vac monofásico, 15 A, 50/60 Hz, con tierra.", "Gases: helio de alta pureza (99,999%); metano de alta pureza (99,999%) si se instala CI; nitrógeno de pureza ultraalta (99,999%).", "Dimensiones: 954 × 1036 × 703 mm (ancho × profundidad × alto). Peso: 156 kg en la configuración descrita por el fabricante.", "Considere una carga térmica promedio de 3440 W. El ambiente de operación debe ser 18–27 °C y 20–80% de humedad relativa sin condensación."] },
      ],
      specificationNotes: [
        { title: "Alcance de las configuraciones", items: ["BRE725540 y BRE725541 son configuraciones GC-MS sin MS/MS; BRE725542 y BRE725543 incorporan capacidad MS/MS. Las diferencias de resolución se limitan a 30.000 o 60.000 a m/z 200 según la configuración.", "La imagen del producto puede variar según la configuración."] },
      ],
      descriptionImages: [
        { src: "/productos/thermo-orbitrap-exploris-gc/vista-angular.png", alt: "Vista angular del Orbitrap Exploris GC", title: "Vista angular del instrumento", caption: "Vista del Orbitrap Exploris GC proporcionada por el fabricante." },
        { src: "/productos/thermo-orbitrap-exploris-gc/integracion-triplus-frontal.png", alt: "Orbitrap Exploris GC con TriPlus RSH SMART", title: "Referencia de integración con TriPlus", caption: "La imagen muestra una integración con el muestreador TriPlus RSH SMART; no se presenta como incluido ni implica venta conjunta." },
        { src: "/productos/thermo-orbitrap-exploris-gc/integracion-triplus-angular.png", alt: "Vista del Orbitrap Exploris GC con TriPlus RSH SMART", title: "Vista de integración con TriPlus", caption: "La imagen muestra una integración con el muestreador TriPlus RSH SMART; no se presenta como incluido ni implica venta conjunta." },
      ],
      complianceNotes: [{ title: "Uso previsto", text: "Solo para uso en investigación. No indicado para uso en procedimientos de diagnóstico." }],
      applicationNotes: [
        { label: "Seguridad alimentaria", text: "El fabricante documenta flujos de tamizaje y cuantificación para contaminantes alimentarios; la biblioteca Orbitrap GC-MS incluye más de 800 contaminantes de alimentos y ambientales." },
        { label: "Análisis ambiental", text: "Datos HRAM, coincidencia espectral e información isotópica apoyan la identificación de contaminantes en matrices complejas." },
        { label: "Perfilado de muestras", text: "Compound Discoverer permite interrogar datos de escaneo completo para análisis de compuestos objetivo, desconocidos y perfiles de muestras." },
        { label: "Control antidopaje", text: "Las plantillas de sistema incluyen una categoría para control antidopaje." },
      ],
    },
  },
  {
  ...
  },
  {
    ...
    name: "Q Exactive Plus Hybrid Quadrupole-Orbitrap Mass Spectrometer",
    category: "Espectrometría de masa",
    filters: ["Marcas", "Espectrometría de masa", "Equipamiento analítico"],
    description: "Espectrómetro de masa híbrido cuadrupolo-Orbitrap para caracterizar, cuantificar y confirmar de forma confiable y rutinaria en un solo análisis. Solo para uso en investigación. No indicado para uso en procedimientos de diagnóstico.",
    features: [
      "Tecnología avanzada de cuadrupolo (AQT) mejora la selección y transmisión de precursores, para cuantificación más precisa de analitos de baja abundancia en matrices complejas",
      "Adquisición independiente de datos (DIA) sofisticada y monitoreo de reacción paralela (PRM) entregan cuantificación reproducible con confianza cualitativa completa",
      "Guía de haz activa avanzada (AABG) reduce el ruido y extiende los intervalos de mantenimiento",
      "Modo opcional de proteína intacta ofrece captura superior de moléculas grandes para mejor análisis de proteínas y complejos proteicos intactos",
      "Resolución mejorada opcional asegura máxima confianza de identificación en proteómica y lipidómica top-down",
      "Capacidades HR/AM y de escaneo completo capturan todos los datos de la muestra en todo momento, permitiendo análisis retrospectivo sin necesidad de repetir la corrida",
      "Poder de resolución de hasta 140.000 FWHM elimina interferencias isobáricas, aumentando la confianza en matrices complejas",
      "Exactitud de masa mejor a 1 ppm en modos de escaneo completo y fragmentación de todos los iones (AIF)",
      "Escaneo rápido a 12 Hz y multiplexado espectral, apto para aplicaciones UHPLC",
      "Cambio de polaridad rápido maximiza la información obtenida",
      "AIF y múltiples técnicas de disociación (CID en fuente y HCD) ayudan en la identificación de compuestos",
      "Rango de masa hasta 6000 m/z mejora la detección de moléculas pequeñas y biomoléculas de carga simple",
      "Más de cuatro órdenes de magnitud de rango dinámico intra-escaneo, con sensibilidad a nivel de femtogramos",
    ],
    imageUrl: "/productos/thermo-q-exactive-plus/portada.png",
    tags: ["Thermo Scientific", "Q Exactive Plus", "Orbitrap", "IQLAAEGAAPFALGMBDK", "LC-MS/MS", "HR/AM", "Quanfirmation"],
    detail: {
      brand: "Thermo Scientific",
      model: "Q Exactive Plus · IQLAAEGAAPFALGMBDK",
      fullTitle: "Q Exactive Plus Hybrid Quadrupole-Orbitrap Mass Spectrometer",
      subtitle: "Quanfirmation combina cuantificación y confirmación cualitativa en un solo análisis, desde screening DMPK hasta caracterización de anticuerpos monoclonales intactos.",
      highlights: ["Hasta 240.000 a m/z 200", "Exactitud interna <1 ppm RMS", "Hasta 12 Hz", "50 a 6000 m/z"],
      advantages: [
        "Selección y transmisión de precursores mediante AQT para analitos de baja abundancia",
        "DIA y PRM para cuantificación reproducible con confianza cualitativa",
        "AABG para reducir ruido y ampliar intervalos de mantenimiento",
        "Modos opcionales para proteínas intactas y resolución mejorada",
      ],
      technicalParameters: [
        { leftParameter: "Código de catálogo", leftValue: "IQLAAEGAAPFALGMBDK", rightParameter: "Tipo", rightValue: "Cuadrupolo-Orbitrap LC-MS" },
        { leftParameter: "Rango dinámico", leftValue: ">5000:1", rightParameter: "Rango de masa", rightValue: "50 a 6000 m/z" },
        { leftParameter: "Exactitud de masa", leftValue: "Interna: <1 ppm RMS; externa: <3 ppm RMS", rightParameter: "Velocidad de escaneo", rightValue: "Hasta 12 Hz" },
        { leftParameter: "Cambio de polaridad", leftValue: "Un ciclo completo en menos de 1 segundo: un escaneo positivo y uno negativo a resolución de 35.000", rightParameter: "Resolución máxima", rightValue: "Hasta 240.000 a m/z 200" },
        { leftParameter: "Sensibilidad Full MS", leftValue: "500 fg de buspirona en columna; S/N 100:1", rightParameter: "Sensibilidad SIM", rightValue: "30 fg de buspirona en columna; S/N 100:1" },
      ],
      detailBlocks: [
        { title: "Cuantificación superior", tone: "green", items: ["AQT mejora la selección y transmisión de precursores en matrices complejas.", "DIA y PRM entregan cuantificación reproducible con información cualitativa.", "AABG reduce el ruido y extiende los intervalos de mantenimiento."] },
        { title: "Análisis mejorado de proteínas intactas", tone: "green", items: ["El modo opcional de proteína intacta mejora la captura de moléculas grandes y complejos proteicos.", "La resolución mejorada opcional aumenta la confianza en proteómica y lipidómica top-down."] },
        { title: "Resultados de alta confianza", tone: "green", items: ["HR/AM y escaneo completo permiten análisis retrospectivo sin repetir la corrida.", "AIF, CID en fuente y HCD apoyan la identificación de compuestos.", "El multiplexado espectral y el cambio rápido de polaridad amplían la información adquirida.", "Rango intra-escaneo superior a cuatro órdenes de magnitud y sensibilidad a nivel de femtogramos."] },
        { title: "Alcance regulatorio", tone: "yellow", items: ["Solo para uso en investigación. No indicado para uso en procedimientos de diagnóstico."] },
      ],
      specificationNotes: [{ title: "Configuración de resolución", items: ["El folleto documenta 140.000 FWHM a m/z 200 y resolución mejorada opcional; la especificación solicitada indica una resolución máxima de hasta 240.000 a m/z 200."] }],
      complianceNotes: [{ title: "Aviso regulatorio del fabricante", text: "Solo para uso en investigación. No indicado para uso en procedimientos de diagnóstico." }],
      applicationNotes: [
        { label: "Cuantificación dirigida", text: "PRM y HR/AM-SIM para péptidos y moléculas pequeñas con alta selectividad." },
        { label: "Proteómica", text: "Identificación y cuantificación de proteínas mediante enfoques bottom-up, top-down y DIA." },
        { label: "Biofarmacéutica", text: "Caracterización de proteínas intactas, subunidades y anticuerpos monoclonales." },
        { label: "DMPK", text: "Screening cualitativo y cuantitativo con confirmación en una sola corrida." },
        { label: "Lipidómica", text: "Resolución mejorada opcional para identificación de alta confianza." },
      ],
    },
  },
  {
  ...
  },
  {
    ...
    filters: ["Marcas", "Espectrometría de masa", "Equipamiento analítico"],
    description:
      "Espectrómetro de masa de relación isotópica (IRMS) para autenticidad alimentaria, forense ambiental y criminal, control antidopaje e investigación científica. Integra análisis isotópico mediante periféricos Thermo Scientific y software Qtegra ISDS.",
    features: [
  ...
  },
  {
    ...
    filters: ["Marcas", "Espectrometría de masa", "Equipamiento analítico"],
    description:
      "Espectrómetro de masa de cuadrupolo simple para incorporar análisis LC-MS de rutina a un sistema LC, HPLC o UHPLC existente. Se configura con fuente HESI o con fuente dual HESI/APCI y requiere suministro de nitrógeno de alta pureza para operar.",
    features: [
      "Dos variantes: ISQEM-ESI con HESI e ISQEM-ESI-APCI con fuente dual HESI/APCI",
      "Rango de masa de m/z 10 a 2000 con resolución de masa unitaria",
      "Nitrógeno ≥99 %: hasta 30 L/min a 90–110 psig",
    ],
    imageUrl: "/productos/thermo-isq-em/portada.png",
    tags: [
      "Thermo Scientific",
      "ISQ EM",
      "ISQEM-ESI",
    ...
    detail: {
      brand: "Thermo Scientific",
      model: "ISQ EM · ISQEM-ESI / ISQEM-ESI-APCI",
      fullTitle:
        "Thermo Scientific ISQ EM — Espectrometría de masa de cuadrupolo simple",
      subtitle:
        "Instrumento de espectrometría de masa de cuadrupolo simple que se acopla a un sistema de cromatografía líquida LC, HPLC o UHPLC existente para análisis LC-MS de rutina. Las variantes ISQEM-ESI e ISQEM-ESI-APCI se diferencian por su fuente de ionización. Para operar requiere nitrógeno de pureza ≥99 %, capaz de entregar hasta 30 L/min a 90–110 psig, además del sistema LC y la bomba mecánica externa documentada por el fabricante.",
      highlights: [
        "ISQEM-ESI con HESI; ISQEM-ESI-APCI con fuente dual HESI/APCI",
        "Rango m/z 10–2000 con resolución de masa unitaria",
        "Nitrógeno ≥99 %: hasta 30 L/min a 90–110 psig",
      ],
      advantages: [
        "La fuente API incorpora diseño de pulverización ortogonal, posición de sonda optimizada y voltaje de fuente ajustable para ionización HESI o APCI según la variante elegida.",
        "El interbloqueo de vacío permite mantenimiento rutinario de la fuente sin ventear el sistema; los controles de gas de vaina, auxiliar y de barrido son ajustables.",
        "El estándar de referencia integrado permite calibración automática del instrumento y la conmutación de polaridad se realiza en 25 ms.",
        "El equipo admite Full Scan, SIM y Full Scan/SIM simultáneo; la confirmación de masa del pico cromatográfico permite diferenciar picos coeluyentes mediante su relación masa-carga.",
        "Chromeleon 7 CDS integra el control del ISQ EM; el fabricante también documenta soporte de aplicaciones multiusuario de acceso abierto mediante Chromeleon XPS.",
      ],
      technicalParameters: [
        {
          leftParameter: "Variantes de catálogo",
          leftValue: "ISQEM-ESI / ISQEM-ESI-APCI",
          rightParameter: "Fuente de ionización",
          rightValue: "ISQEM-ESI: HESI; ISQEM-ESI-APCI: dual HESI/APCI intercambiable",
        },
        {
          leftParameter: "Rango de masa",
          leftValue: "m/z 10–2000; resolución de masa unitaria (~1,0 m/z base; ~0,7 m/z FWHM)",
          rightParameter: "Tipo de fuente",
          rightValue: "API con pulverización ortogonal, posición de sonda optimizada y voltaje de fuente ajustable",
        },
        {
          leftParameter: "Acceso a fuente y gases",
          leftValue: "Interbloqueo de vacío; controles ajustables de gas de vaina, auxiliar y de barrido",
          rightParameter: "Caudal HESI/APCI",
          rightValue: "Hasta 2,0 mL/min",
        },
        {
          leftParameter: "Modos compatibles",
          leftValue: "Full Scan, SIM y Full Scan/SIM simultáneo",
          rightParameter: "Velocidad de escaneo",
          rightValue: "Hasta 20.000 Da/s",
        },
        {
          leftParameter: "Cambio de polaridad",
          leftValue: "Sí, 25 ms",
          rightParameter: "Exactitud de masa",
          rightValue: "≤ ±0,1 m/z",
        },
        {
          leftParameter: "Estabilidad de masa",
          leftValue: "Mejor que 0,1 m/z durante 48 h con ΔT ≤ 2 K",
          rightParameter: "Detector",
          rightValue: "DynaMax XR: dinodo fuera de eje, multiplicador de electrones de dinodo discreto y electrómetro; rango dinámico digital ≥10⁷",
        },
        {
          leftParameter: "Sensibilidad SIM HESI positivo",
          leftValue: "10 pg de reserpina, S/N ≥400:1 (RMS), 400 μL/min; m/z 609,3",
          rightParameter: "Sensibilidad SIM HESI negativo",
          rightValue: "20 pg de p-nitrofenol, S/N ≥500:1 (RMS), 400 μL/min; m/z 138,0",
        },
        {
          leftParameter: "Sensibilidad SIM APCI positivo",
          leftValue: "10 pg de reserpina, S/N ≥1000:1 (RMS), 400 μL/min; m/z 609,3",
          rightParameter: "Sensibilidad SIM APCI negativo",
          rightValue: "20 pg de p-nitrofenol, S/N ≥80:1 (RMS), 900 μL/min; m/z 138,0",
        },
        {
          leftParameter: "Escaneos SIM por método",
          leftValue: "Ilimitados",
          rightParameter: "Escaneos SIM por segundo",
          rightValue: "Máximo 218",
        },
        {
          leftParameter: "Bomba de vacío previa",
          leftValue: "Mecánica externa, con aceite; hasta 10 m³/h",
          rightParameter: "Condiciones de operación",
          rightValue: "15–35 °C; humedad relativa 20–80 % sin condensación",
        },
        {
          leftParameter: "Requisito de nitrógeno",
          leftValue: "Pureza ≥99 %; hasta 30 L/min; 90–110 psig",
          rightParameter: "Alimentación",
          rightValue: "100–240 VAC, 50/60 Hz",
        },
        {
          leftParameter: "Dimensiones (Al × An × Pr)",
          leftValue: "52 × 42 × 91 cm",
          rightParameter: "Peso",
          rightValue: "71,4 kg",
        },
        {
          leftParameter: "Software de datos",
          leftValue: "Chromeleon 7 CDS bajo Microsoft Windows 10 y 11",
          rightParameter: "Integración LC",
          rightValue: "Para sistemas LC, HPLC o UHPLC existentes; la imagen de integración es solo referencial",
        },
      ],
      detailBlocks: [
        {
          title: "Elección de fuente de ionización",
          tone: "green",
          items: [
            "ISQEM-ESI utiliza ionización por electrospray calentado (HESI). ISQEM-ESI-APCI incorpora una fuente dual con HESI o APCI intercambiable para ampliar la selección de analitos.",
            "La documentación relaciona APCI con analitos menos polares o de bajo peso molecular; HESI y APCI están especificadas para caudales de hasta 2,0 mL/min.",
          ],
        },
        {
          title: "Análisis LC-MS de rutina",
          tone: "blue",
          items: [
            "El equipo integra datos de masa a un sistema de cromatografía líquida existente para detectar y cuantificar moléculas pequeñas y grandes en modos Full Scan, SIM o Full Scan/SIM simultáneo.",
            "La confirmación de masa del pico cromatográfico aumenta selectividad en matrices complejas y permite resolver picos coeluyentes mediante su relación masa-carga.",
          ],
        },
        {
          title: "Requisitos de instalación",
          tone: "yellow",
          items: [
            "Antes de instalar, confirme un suministro de nitrógeno de pureza ≥99 % capaz de aportar hasta 30 L/min a 90–110 psig. La guía también documenta conexión a ventilación para el escape de la fuente de iones.",
            "El sistema requiere un LC, HPLC o UHPLC existente, una bomba mecánica externa con aceite y alimentación de 100–240 VAC, 50/60 Hz. La guía de preinstalación detalla condiciones ambientales, espacio y electricidad del sitio.",
          ],
        },
      ],
      descriptionImages: [
        {
          ...
          alt: "ISQ EM conectado a un sistema de cromatografía líquida como ejemplo de integración LC-MS",
          title: "Referencia de integración LC-MS",
          caption:
            "La imagen ilustra el ISQ EM conectado a un sistema LC Vanquish. Es una referencia de integración de la espectrometría de masa con cromatografía líquida; no presenta el sistema Vanquish como producto incluido ni disponible en esta ficha.",
        },
      ],
      complianceNotes: [
        {
      ...
      applicationNotes: [
        {
          label: "LC-MS de rutina",
          text: "La ficha técnica documenta análisis LC-MS de rutina para moléculas pequeñas y grandes mediante un sistema de cromatografía líquida existente.",
        },
        {
          label: "LC e IC con espectrometría de masa",
          text: "La guía de preinstalación declara uso previsto en aplicaciones de espectrometría de masa con cromatografía líquida (LC) y cromatografía iónica (IC).",
        },
        {
          label: "Matrices complejas",
          text: "El fabricante documenta respuesta consistente en matrices complejas y confirmación de masa para aumentar selectividad frente a picos coeluyentes.",
        },
      ],
    },
  },
