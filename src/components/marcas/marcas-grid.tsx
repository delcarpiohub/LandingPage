...
function BrandCell({ brand }: { brand: Brand }) {
  return (
    <a
      ...
      aria-label={`Visitar sitio oficial de ${brand.name}`}
      className="flex min-h-[152px] items-center justify-center bg-white px-4 py-8 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-[-2px] focus-visible:outline-[#D6532B] md:min-h-[184px] md:p-10"
    >
      <Image
        src={brand.logo}
        alt=""
