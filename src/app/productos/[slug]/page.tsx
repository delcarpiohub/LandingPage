...
export default async function ProductDetailPage({
  ...
  const isHyperpurexLuDiscoveryPage =
    product.slug === "hyperpurex-serie-lu-discovery";
  const isHyperpurexXFlagshipPage =
    product.slug === "hyperpurex-serie-x-flagship";
  const isHyperpurexPPursuitPage =
    product.slug === "hyperpurex-serie-p-pursuit";
  const isHyperpurexFxFlagshipPage =
    product.slug === "hyperpurex-serie-fx-flagship";
  const isHyperpurexFeEminentPage =
    product.slug === "hyperpurex-serie-fe-eminente";
  const isHyperpurexFsSmartPage =
    product.slug === "hyperpurex-serie-fs-smart";
  const isMilestonePage = product.slug?.startsWith("milestone-") ?? false;
  const isInfitekPage = product.slug?.startsWith("infitek-") ?? false;
  const isTeInstrumentsPage =
    product.slug?.startsWith("te-instruments-") ?? false;
  ...
  const hasBrochure =
    ...
    [
      ...
      "infitek-mca-series",
      "infitek-ph-b100bd",
      "infitek-usc-m-series",
      "infitek-don-h-series",
      "infitek-lyo60b-series",
      "infitek-fmh-series",
      "infitek-fmh-pa-series",
      "infitek-wb-series",
      "infitek-pr5-series",
      "infitek-titr-50vc",
            ...
            ? [
                {
                  ...
                  href: "/productos/thermo-isq-ec/ficha-tecnica-isq-ec-en.pdf",
                  download: "Ficha_Tecnica_Thermo_Scientific_ISQ_EC_EN.pdf",
                },
                {
                  label: "Guía de requisitos de preinstalación ISQ EC (PDF en inglés)",
                  href: "/productos/thermo-isq-ec/guia-preinstalacion-isq-ec-en.pdf",
                  download: "Guia_Preinstalacion_Thermo_Scientific_ISQ_EC_EN.pdf",
                },
              ]
      : product.slug === "decent-hornos-secado"
      ? [
          {
            ...
            href: "/productos/decent/hornos-secado/ficha-hornos-industriales-1350-2500.jpg",
            download: "Ficha_Hornos_DDO_1350_2500.jpg",
          },
          {
            label: "Hornos industriales de 5.000 y 10.000 L",
            href: "/productos/decent/hornos-secado/ficha-hornos-industriales-5000-10000.jpg",
            download: "Ficha_Hornos_DDO_5000_10000.jpg",
          },
          {
            label: "Grandes hornos eléctricos DDO4 a DDO8",
            href: "/productos/decent/hornos-secado/ficha-hornos-electricos-grandes.jpg",
            download: "Ficha_Hornos_DDO4_DDO8.jpg",
          },
          {
            label: "Hornos eléctricos de convección forzada DDOG",
            href: "/productos/decent/hornos-secado/ficha-hornos-conveccion-forzada.jpg",
            download: "Ficha_Hornos_DDOG.jpg",
          },
          {
            label: "Hornos eléctricos de temperatura constante DDOH y DDOHL",
            href: "/productos/decent/hornos-secado/ficha-hornos-conveccion-natural.jpg",
            download: "Ficha_Hornos_DDOH_DDOHL.jpg",
          },
          {
            label: "Hornos horizontales DDO101 y DDO202",
            href: "/productos/decent/hornos-secado/ficha-hornos-horizontales.jpg",
            download: "Ficha_Hornos_DDO101_DDO202.jpg",
          },
        ]
      : [];
    ...
    ? [
        {
          ...
          alt: "Sistema de purificación de agua Hyperpurex Serie FE Eminent",
        },
        {
          src: "/productos/hyperpurex-serie-fe-eminente/equipo-panel.png",
          alt: "Pantalla de control del sistema Hyperpurex Serie FE Eminent",
        },
      ]
    : isHyperpurexFsSmartPage
      ? [
          {
            src: "/productos/hyperpurex-serie-fs-smart/portada.png",
            alt: "Sistema de purificación de agua Hyperpurex Serie FS Smart",
          },
          {
            src: "/productos/hyperpurex-serie-fs-smart/equipo-panel.png",
            alt: "Panel de control del sistema Hyperpurex Serie FS Smart",
          },
        ]
    : isHyperpurexPPursuitPage
    ? [
        {
          src: "/productos/hyperpurex-serie-p-pursuit/portada.png",
          alt: "Sistema de agua ultrapura Hyperpurex Serie P Pursuit",
        },
        {
          src: "/productos/hyperpurex-serie-p-pursuit/equipo-panel.png",
          alt: "Panel de control del sistema Hyperpurex Serie P Pursuit",
        },
      ]
    : isHyperpurexFxFlagshipPage
      ? [
          {
            src: "/productos/hyperpurex-serie-fx-flagship/portada.png",
            alt: "Estación de agua para laboratorio Hyperpurex Serie FX Flagship",
          },
          {
            src: "/productos/hyperpurex-serie-fx-flagship/equipo-panel.png",
            alt: "Panel de control de la estación Hyperpurex Serie FX Flagship",
          },
        ]
    : isHyperpurexXFlagshipPage
    ? [
        {
          src: "/productos/hyperpurex-serie-x-flagship/portada.png",
          alt: "Sistema Hyperpurex Serie X Flagship",
        },
        {
          src: "/productos/hyperpurex-serie-x-flagship/equipo-panel.png",
          alt: "Panel frontal del sistema Hyperpurex Serie X Flagship",
        },
      ]
    : isHyperpurexLuDiscoveryPage
      ? [
          {
            src: "/productos/hyperpurex-serie-lu-discovery/portada.png",
            alt: "Sistema y tanque de almacenamiento Hyperpurex Serie LU Discovery",
          },
          {
            src: "/productos/hyperpurex-serie-lu-discovery/equipo-vista-2.png",
            alt: "Vista alternativa del sistema Hyperpurex Serie LU Discovery",
          },
          {
            src: "/productos/hyperpurex-serie-lu-discovery/equipo-vista-3.png",
            alt: "Detalle del equipo y brazo dispensador de la Serie LU Discovery",
          },
        ]
      : isHyperpurexEuePage
        ? [
            {
              src: "/productos/hyperpurex-serie-eue/equipo-vista-general.png",
              alt: "Equipos Hyperpurex de la Serie EUE",
            },
            {
              src: "/productos/hyperpurex-serie-eue/equipo-vista-alternativa.png",
              alt: "Vista alternativa del equipo Hyperpurex Serie EUE",
            },
            {
              src: "/productos/hyperpurex-serie-eue/equipo-vista-lateral.png",
              alt: "Vista lateral del equipo Hyperpurex Serie EUE",
            },
            {
              src: "/productos/hyperpurex-serie-eue/equipo-panel-de-control.png",
              alt: "Panel de control del equipo Hyperpurex Serie EUE",
            },
          ]
        : isHyperpurexPage
          ? [
              {
                src: "/productos/hyperpurex-serie-su-smart/portada.png",
                alt: "Sistema de agua pura y ultrapura Hyperpurex Serie SU Smart",
              },
              {
                src: "/productos/hyperpurex-serie-su-smart/vista-lateral.png",
                alt: "Vistas del sistema Hyperpurex Serie SU Smart",
              },
              {
                src: "/productos/hyperpurex-serie-su-smart/panel-de-control.png",
                alt: "Panel LCD táctil del sistema Hyperpurex Serie SU Smart",
              },
            ]
          : isK1160
            ? [
                {
                  ...
                  alt: "Detalle del sistema de titulación y condensación del analizador",
                },
                {
                  src: "/productos/hanon-k1160/autosampler.webp",
                  alt: "Autosampler K1124 de 24 posiciones para el analizador Kjeldahl",
                },
                {
                  src: "/productos/hanon-k1160/frontal.png",
                  alt: "Vista frontal del analizador Kjeldahl automático Hanon K1160",
                },
              ]
            : isK9860
              ? [
                  {
                    ...
                    alt: "Vista frontal del analizador Kjeldahl automático Hanon K9860",
                  },
                  {
                ...
                ? [
                    {
                      ...
                      alt: "Vista frontal del analizador Kjeldahl automático Hanon K9840",
                    },
                    {
                  ...
                  ? [
                      {
                        ...
                        alt: "Vista frontal del extractor automático Soxhlet Hanon SOX606",
                      },
                      {
                        src: "/productos/hanon-sox606/imagen-8.png",
                        alt: "Detalle del panel táctil y rack de extracción del extractor SOX606",
                      },
                      {
                    ...
                    ? [
                        {
                          ...
                          alt: "Vista frontal principal del digestor Kjeldahl Hanon SH220F",
                        },
                        {
                          src: "/productos/hanon-sh220f/imagen-2.png",
                          alt: "Vista angulada del digestor Kjeldahl Hanon SH220F con panel de control lateral",
                        },
                        {
                          src: "/productos/hanon-sh220f/imagen-3.png",
                          alt: "Vista frontal del digestor SH220F with rack de tubos de digestión instalado",
                        },
                        {
                          src: "/productos/hanon-sh220f/imagen-4.webp",
                          alt: "Detalle lateral posterior del digestor SH220F con conexión de cableado y ventilación",
                        },
                      ]
                      ...
                      ? [
                          {
                            ...
                            alt: "Vista frontal principal del digestor Kjeldahl Hanon SH420F con campana recolectora",
                          },
                          {
                        ...
                        ? [
                            {
                              ...
                              alt: "Vista frontal principal del analizador Kjeldahl automático Hanon K1100F",
                            },
                            {
                          ...
                          ? [
                              {
                                ...
                                alt: "Vista frontal principal del digestor automático Kjeldahl Hanon SH520/SH508",
                              },
                              {
                                src: "/productos/hanon-sh420f/imagen-3.webp",
                          ...
                          : product.slug === "hanon-s402"
                            ? [
                                {
                                  ...
                                  alt: "Vista frontal principal del sistema de agotamiento de gases Hanon S402",
                                },
                                {
                            ...
                            : product.slug === "hanon-sox406"
                              ? [
                                  ...
                                  {
                                    src: "/productos/hanon-sox406/imagen-alternative.png",
                                    alt: "Vista frontal del analizador semi automático SOX406 con fondo sólido",
                                  },
                                  {
                                  ...
                                  ? [
                                      {
                                        ...
                                        alt: "Fotografía frontal del analizador Dumas Hanon D50-D200",
                                      },
                                      {
                                        src: "/productos/hanon-d50-d200/imagen-detail.png",
                                        alt: "Detalle del sistema de muestreo automático",
                                      },
                                      {
                                        src: "/productos/hanon-d50-d200/consumible.png",
                                        alt: "Detalle de los consumibles del equipo Dumas",
                                      },
                                    ]
                                    ...
                                    ? [
                                        {
                                          ...
                                          alt: "Vista frontal del analizador Dumas Hanon E500",
                                        },
                                        {
                                          src: "/productos/hanon-e500/imagen-2.png",
                                          alt: "Muestreador automático del analizador Dumas E500",
                                        },
                                        {
                                          src: "/productos/hanon-e500/imagen-3.png",
                                          alt: "Sistema de tubos del analizador Dumas E500",
                                        },
                                      ]
                                    : product.slug === "milestone-ethos-up"
                                      ? [
                                          {
                                            src: "/productos/milestone-ethos-up/imagen-1.jpg",
                                            alt: "Vista frontal del equipo de digestión por microondas Milestone ETHOS UP",
                                          },
                                          {
                                            src: "/productos/milestone-ethos-up/imagen-2.png",
                                            alt: "Pantalla de interfaz y cavidad del equipo ETHOS UP",
                                          },
                                          {
                                            src: "/productos/milestone-ethos-up/rotor-sk-15.jpg",
                                            alt: "Rotor SK-15 de alta presión para ETHOS UP",
                                          },
                                          {
                                            src: "/productos/milestone-ethos-up/rotor-maxi-44.jpg",
                                            alt: "Rotor MAXI-44 de alto rendimiento para ETHOS UP",
                                          },
                                        ]
                                      : product.slug === "infitek-cod-analyzer"
                                        ? [
                                            {
                                              src: "/productos/infitek/cod-analyzer/imagen-1.png",
                                              alt: "Vista frontal Analizador de DQO COD-Analyzer",
                                            },
                                          ]
                                        : product.slug === "infitek-bep-m300f"
                                          ? [
                                              {
                                                src: "/productos/infitek/bep-m300f/imagen-1.png",
                                                alt: "Analizador Multiparamétrico BEP-M300F",
                                              },
                                            ]
                                          : product.slug ===
                                              "infitek-mca-series"
                                            ? [
                                                {
                                                  src: "/productos/infitek/mca-series/imagen-1.png",
                                                  alt: "Vista frontal Analizador de Humedad Serie MCA",
                                                },
                                                {
                                                  src: "/productos/infitek/mca-series/imagen-2.png",
                                                  alt: "Detalle del Analizador de Humedad Serie MCA",
                                                },
                                              ]
                                            : product.slug ===
                                                "infitek-ph-b100bd"
                                              ? [
                                                  {
                                                    src: "/productos/infitek/ph-b100bd/imagen-1.png",
                                                    alt: "Vista principal Medidor de pH PH-B100BD",
                                                  },
                                                  {
                                                    src: "/productos/infitek/ph-b100bd/imagen-2.png",
                                                    alt: "Detalle del Medidor de pH PH-B100BD y electrodo",
                                                  },
                                                ]
                                              : product.slug ===
                                                  "infitek-usc-m-series"
                                                ? [
                                                    {
                                                      src: "/productos/infitek/usc-m-series/imagen-1.png",
                                                      alt: "Vista principal Limpiador Ultrasónico Serie USC-M",
                                                    },
                                                    {
                                                      src: "/productos/infitek/usc-m-series/imagen-2.png",
                                                      alt: "Detalle del Limpiador Ultrasónico Serie USC-M",
                                                    },
                                                  ]
                                                : product.slug ===
                                                    "infitek-don-h-series"
                                                  ? [
                                                      {
                                                        src: "/productos/infitek/don-h-series/imagen-1.png",
                                                        alt: "Vista principal Horno de Secado DON-H",
                                                      },
                                                    ]
                                                  : product.slug ===
                                                      "infitek-lyo60b-series"
                                                    ? [
                                                        {
                                                          src: "/productos/infitek/lyo60b-series/imagen-1.png",
                                                          alt: "Liofilizador LYO60B Vista 1",
                                                        },
                                                        {
                                                          src: "/productos/infitek/lyo60b-series/imagen-2.png",
                                                          alt: "Liofilizador LYO60B Vista 2",
                                                        },
                                                        {
                                                          src: "/productos/infitek/lyo60b-series/imagen-3.png",
                                                          alt: "Liofilizador LYO60B Vista 3",
                                                        },
                                                        {
                                                          src: "/productos/infitek/lyo60b-series/imagen-4.png",
                                                          alt: "Liofilizador LYO60B Vista 4",
                                                        },
                                                      ]
                                                    : product.slug ===
                                                        "infitek-fmh-series"
                                                      ? [
                                                          {
                                                            src: "/productos/infitek/fmh-series/imagen-1.png",
                                                            alt: "Campana Extractora FMH Vista 1",
                                                          },
                                                          {
                                                            src: "/productos/infitek/fmh-series/imagen-2.png",
                                                            alt: "Campana Extractora FMH Vista 2",
                                                          },
                                                          {
                                                            src: "/productos/infitek/fmh-series/imagen-3.png",
                                                            alt: "Campana Extractora FMH Vista 3",
                                                          },
                                                          {
                                                            src: "/productos/infitek/fmh-series/imagen-4.png",
                                                            alt: "Campana Extractora FMH Vista 4",
                                                          },
                                                        ]
                                                      : product.slug ===
                                                          "infitek-fmh-pa-series"
                                                        ? [
                                                            {
                                                              src: "/productos/infitek/fmh-pa-series/imagen-1.png",
                                                              alt: "Campana Extractora PP FMH-PA Vista 1",
                                                            },
                                                          ]
                                                        : product.slug ===
                                                            "infitek-wb-series"
                                                          ? [
                                                              {
                                                                src: "/productos/infitek/wb-series/imagen-1.png",
                                                                alt: "Baño de agua de acero inoxidable Infitek WB-1R2H-7",
                                                              },
                                                            ]
                                                          : product.slug ===
                                                              "infitek-pr5-series"
                                                            ? [
                                                                {
                                                                  src: "/productos/infitek/pr5-series/imagen-1.png",
                                                                  alt: "Refrigerador de farmacia de tres puertas Infitek PR5-1500",
                                                                },
                                                              ]
                                                            : product.slug ===
                                                                "infitek-titr-50vc"
                                                              ? [
                                                                  {
                                                                    src: "/productos/infitek/titr-50vc/imagen-1.png",
                                                                    alt: "Titulador Karl Fischer volumétrico y coulométrico Infitek TITR-50VC",
                                                                  },
                                                                ]
                                                              : product.slug ===
                                                                ...
                                                                ? [
                                                                    {
                                                                      src: "/productos/te-instruments/xplorer-aox-tox/imagen-1.png",
                                                                      alt: "Vista principal del analizador de halógenos orgánicos totales XplorerPlus AOX/TOX",
                                                                    },
                                                                    {
                                                                      src: "/productos/te-instruments/xplorer-aox-tox/imagen-2.png",
                                                                      alt: "Detalle del módulo de combustión y titulación microcoulombimétrica XplorerPlus",
                                                                    },
                                                                    {
                                                                      src: "/productos/te-instruments/xplorer-aox-tox/imagen-3.png",
                                                                      alt: "Vista alternativa del sistema analítico TE Instruments XplorerPlus AOX/TOX",
                                                                    },
                                                                  ]
                                                                : product.slug ===
                                                                  ...
                                                                  ? [
                                                                      {
                                                                        src: "/productos/te-instruments/xplorer-tn/imagen-1.png",
                                                                        alt: "Analizador de Nitrógeno Total, Azufre y Cloro XplorerPlus TN",
                                                                      },
                                                                      {
                                                                        src: "/productos/te-instruments/xplorer-tn/imagen-2.png",
                                                                        alt: "Detalle del sistema analítico y módulos de combustión XplorerPlus TN",
                                                                      },
                                                                      {
                                                                        src: "/productos/te-instruments/xplorer-tn/imagen-3.png",
                                                                        alt: "Vista de componentes internos y tubo de combustión XproPlus",
                                                                      },
                                                                      {
                                                                        src: "/productos/te-instruments/xplorer-tn/imagen-4.png",
                                                                        alt: "Módulos de introducción y barca con sistema Boat CoolingPlus",
                                                                      },
                                                                      {
                                                                        src: "/productos/te-instruments/xplorer-tn/imagen-5.png",
                                                                        alt: "Vista posterior y conexiones de gases del analizador XplorerPlus TN",
                                                                      },
                                                                    ]
                                                                  : product.slug ===
                                                                    ...
                                                                    ? [
                                                                        {
                                                                          src: "/productos/te-instruments/vectra/imagen-1.png",
                                                                          alt: "Autosampler y Muestreador Automático de Líquidos VECTRA",
                                                                        },
                                                                        {
                                                                          src: "/productos/te-instruments/vectra/imagen-2.png",
                                                                          alt: "Vista del brazo robótico XYZ con rotación angular y cámara HD",
                                                                        },
                                                                        {
                                                                          src: "/productos/te-instruments/vectra/imagen-3.png",
                                                                          alt: "Detalle de bandejas acondicionadas y posiciones de viales VECTRA",
                                                                        },
                                                                        {
                                                                          src: "/productos/te-instruments/vectra/imagen-4.png",
                                                                          alt: "Estaciones de estacionamiento e intercambio automático de jeringas",
                                                                        },
                                                                        {
                                                                          src: "/productos/te-instruments/vectra/imagen-5.png",
                                                                          alt: "Integración de VECTRA sobre analizador elemental Xplorer Series",
                                                                        },
                                                                      ]
                                                                    : product.slug ===
                                                                      ...
                                                                      ? [
                                                                          {
                                                                            src: "/productos/te-instruments/newton/imagen-1.png",
                                                                            alt: "Autosampler y Muestreador Automático de Sólidos NEWTON",
                                                                          },
                                                                          {
                                                                            src: "/productos/te-instruments/newton/imagen-2.png",
                                                                            alt: "Vista del carrusel apilable y tapa de preservación NEWTON",
                                                                          },
                                                                          {
                                                                            src: "/productos/te-instruments/newton/imagen-3.png",
                                                                            alt: "Detalle del mecanismo de introducción por barca de cuarzo y copas",
                                                                          },
                                                                          {
                                                                            src: "/productos/te-instruments/newton/imagen-4.png",
                                                                            alt: "Integración de NEWTON sobre horno de combustión XPLORER",
                                                                          },
                                                                        ]
                                                                      : product.slug ===
                                                                          "decent-cargador-electrico-crisoles"
                                                                        ? [
                                                                            {
                                                                              ...
                                                                              alt: "Fotografía principal del cargador eléctrico de crisoles Decent DEPL25/DEPL50",
                                                                            },
                                                                            {
                                                                              src: "/productos/decent/cargador-electrico-crisoles/Imagen 2.webp",
                                                                              alt: "Detalle de horquilla y chasis del cargador eléctrico DEPL",
                                                                            },
                                                                            {
                                                                              src: "/productos/decent/cargador-electrico-crisoles/Imagen para la descripcion.webp",
                                                                              alt: "Panel de control y cargador integrado con batería sin mantenimiento",
                                                                            },
                                                                          ]
                                                                        : product.slug ===
                                                                            "decent-cargador-manual-crisoles"
                                                                          ? [
                                                                              {
                                                                                ...
                                                                                alt: "Fotografía principal del cargador manual de crisoles Decent DMPL25/DMPL50",
                                                                              },
                                                                              {
                                                                                src: "/productos/decent/cargador-manual-crisoles/Imagen 2.webp",
                                                                                alt: "Detalle de estructura y sistema de elevación manual DMPL",
                                                                              },
                                                                            ]
                                                                          : product.slug ===
                                                                              "decent-copelas-magnesio"
                                                                            ? [
                                                                                ...
                                                                                },
                                                                                {
                                                                                  ...
                                                                                  alt: "Detalle de dimensiones y modelos de copelas de magnesia Decent",
                                                                                },
                                                                                {
                                                                                  src: "/productos/decent/copelas-magnesio/Imagen 3.jpg",
                                                                                  alt: "Lote de copelas de óxido de magnesio para ensayo de metales preciosos",
                                                                                },
                                                                              ]
                                                                            : product.slug ===
                                                                                "decent-dosificador-automatico-litargirio"
                                                                              ? [
                                                                                  ...
                                                                                  {
                                                                                    src: "/productos/decent/dosificador-automatico-litargirio/Imagen 4.png",
                                                                                    alt: "Cámara cerrada anti-polvo del dosificador Decent DAFS84",
                                                                                  },
                                                                                ]
                                                                              : product.slug ===
                                                                                  "decent-hornos-cupelacion"
                                                                                ? [
                                                                                    ...
                                                                                    },
                                                                                    {
                                                                                      ...
                                                                                      alt: "Detalle de la cámara de mufla y puerta neumática del horno de cupelación",
                                                                                    },
                                                                                    {
                                                                                      src: "/productos/decent/hornos-cupelacion/Imagen 3.webp",
                                                                                      alt: "Vista lateral del sistema neumático y cuadro de potencia del horno Decent",
                                                                                    },
                                                                                    {
                                                                                      src: "/productos/decent/hornos-cupelacion/Imagen 4.webp",
                                                                                      alt: "Interior de la mufla refractaria con elementos calefactores de carburo de silicio",
                                                                                    },
                                                                                  ]
                                                                                : product.slug ===
                                                                                  ...
                                                                                  ? [
                                                                                      ...
                                                                                      },
                                                                                      {
                                                                                        ...
                                                                                        alt: "Consola de control independiente y pantalla táctil del horno de alta temperatura",
                                                                                      },
                                                                                      {
                                                                                      ...
                                                                                      {
                                                                                        src: "/productos/decent/horno-copelacion-alta-temperatura/Imagen 4.png",
                                                                                        alt: "Detalle de la puerta neumática y ventana de observación ignífuga",
                                                                                      },
                                                                                    ]
                                                                                  : product.slug ===
                                                                                      "decent-hornos-fusion-ensayo-fuego"
                                                                                      ...
                                                                                      : product.slug ===
                                                                                        ...
                                                                                        ? [
                                                                                            ...
                                                                                            },
                                                                                            {
                                                                                              ...
                                                                                              alt: "Vista frontal cerrada del molino pulverizador de laboratorio DP1000",
                                                                                            },
                                                                                            {
                                                                                              src: "/productos/decent/molino-pulverizador-dp1000/Imagen 3.jpg",
                                                                                              alt: "Detalle del sistema de fijación y movimiento del molino pulverizador DP1000",
                                                                                            },
                                                                                            {
                                                                                              src: "/productos/decent/molino-pulverizador-dp1000/Imagen 4.png",
                                                                                              alt: "Vista del molino DP1000 con paneles de control y parada de emergencia",
                                                                                            },
                                                                                          ]
                                                                                        : product.slug ===
                                                                                            "decent-drsd05"
                                                                                          ? [
                                                                                              {
                                                                                                src: "/productos/decent/drsd05/Imagen Portada.png",
                                                                                                alt: "Vista principal del divisor de muestras giratorio de sobremesa Decent DRSD05",
                                                                                              },
                                                                                              {
                                                                                                src: "/productos/decent/drsd05/Imagen 2.png",
                                                                                                alt: "Vista complementaria del divisor de muestras giratorio Decent DRSD05",
                                                                                              },
                                                                                              {
                                                                                                src: "/productos/decent/drsd05/Imagen 3.png",
                                                                                                alt: "Detalle complementario del divisor de muestras giratorio Decent DRSD05",
                                                                                              },
                                                                                            ]
                                                                                          : product.slug ===
                                                                                              "decent-drsd40"
                                                                                            ? [
                                                                                                {
                                                                                                  src: "/productos/decent/drsd40/Imagen Portada.png",
                                                                                                  alt: "Vista principal del divisor rotativo de muestras Decent DRSD40",
                                                                                                },
                                                                                                {
                                                                                                  src: "/productos/decent/drsd40/Imagen 2.png",
                                                                                                  alt: "Vista complementaria del divisor rotativo de muestras Decent DRSD40",
                                                                                                },
                                                                                              ]
                                                                                            : product.slug ===
                                                                                              ...
                                                                                              ? [
                                                                                                  {
                                                                                                    src: "/productos/decent/trituradora-martillo/Imagen Portada.png",
                                                                                                    alt: "Vista principal de la trituradora de martillo de laboratorio Decent",
                                                                                                  },
                                                                                                  {
                                                                                                    src: "/productos/decent/trituradora-martillo/Imagen 2.png",
                                                                                                    alt: "Vista complementaria de la trituradora de martillo de laboratorio Decent",
                                                                                                  },
                                                                                                  {
                                                                                                    src: "/productos/decent/trituradora-martillo/Imagen 3.png",
                                                                                                    alt: "Detalle complementario de la trituradora de martillo de laboratorio Decent",
                                                                                                  },
                                                                                                ]
                                                                                              : product.slug ===
                                                                                                  "decent-rodillo-botella"
                                                                                                ? [
                                                                                                    {
                                                                                                      src: "/productos/decent/rodillo-botella/Imagen Portada.png",
                                                                                                      alt: "Vista principal del rodillo de botella Decent",
                                                                                                    },
                                                                                                    {
                                                                                                      src: "/productos/decent/rodillo-botella/Imagen 2.png",
                                                                                                      alt: "Vista complementaria del rodillo de botella Decent",
                                                                                                    },
                                                                                                    {
                                                                                                      src: "/productos/decent/rodillo-botella/Imagen 3.png",
                                                                                                      alt: "Detalle complementario del rodillo de botella Decent",
                                                                                                    },
                                                                                                    {
                                                                                                      src: "/productos/decent/rodillo-botella/Imagen 4.png",
                                                                                                      alt: "Detalle del sistema de rodillos del rodillo de botella Decent",
                                                                                                    },
                                                                                                  ]
                                                                                                : product.slug ===
                                                                                                    "decent-dsw350"
                                                                                                  ? [
                                                                                                      {
                                                                                                        src: "/productos/decent/dsw350/Imagen Portada.png",
                                                                                                        alt: "Vista principal de la estación de trabajo autónoma Decent DSW350",
                                                                                                      },
                                                                                                      {
                                                                                                        src: "/productos/decent/dsw350/Imagen 2.png",
                                                                                                        alt: "Vista complementaria de la estación de trabajo autónoma Decent DSW350",
                                                                                                      },
                                                                                                      {
                                                                                                        src: "/productos/decent/dsw350/Imagen 3.png",
                                                                                                        alt: "Detalle complementario de la estación de trabajo autónoma Decent DSW350",
                                                                                                      },
                                                                                                    ]
                                                                                                  : product.slug ===
                                                                                                      "decent-mezclador-tipo-v"
                                                                                                    ? [
                                                                                                        {
                                                                                                          src: "/productos/decent/mezclador-tipo-v/Imagen Portada.png",
                                                                                                          alt: "Vista principal del mezclador tipo V Decent",
                                                                                                        },
                                                                                                        {
                                                                                                          src: "/productos/decent/mezclador-tipo-v/Imagen 2.png",
                                                                                                          alt: "Vista complementaria del mezclador tipo V Decent",
                                                                                                        },
                                                                                                        {
                                                                                                          src: "/productos/decent/mezclador-tipo-v/Imagen 3.png",
                                                                                                          alt: "Detalle complementario del mezclador tipo V Decent",
                                                                                                        },
                                                                                                        {
                                                                                                          src: "/productos/decent/mezclador-tipo-v/Imagen 4.jpg",
                                                                                                          alt: "Detalle adicional del mezclador tipo V Decent",
                                                                                                        },
                                                                                                      ]
                                                                                                    : product.slug ===
                                                                                                        "decent-trituradora-doble-rodillo"
                                                                                                      ? [
                                                                                                          {
                                                                                                            src: "/productos/decent/trituradora-doble-rodillo/Imagen Portada.png",
                                                                                                            alt: "Vista principal de la trituradora de doble rodillo Decent",
                                                                                                          },
                                                                                                          {
                                                                                                            src: "/productos/decent/trituradora-doble-rodillo/Imagen 2.png",
                                                                                                            alt: "Vista complementaria de la trituradora de doble rodillo Decent",
                                                                                                          },
                                                                                                        ]
                                                                                                      : product.slug ===
                                                                                                          "decent-agitador-tamiz-estandar"
                                                                                                        ? [
                                                                                                            {
                                                                                                              src: "/productos/decent/agitador-tamiz-estandar/Imagen Portada.png",
                                                                                                              alt: "Vista principal del agitador de tamiz estándar Decent",
                                                                                                            },
                                                                                                            {
                                                                                                              src: "/productos/decent/agitador-tamiz-estandar/Imagen 2.png",
                                                                                                              alt: "Vista del agitador de tamiz estándar Decent",
                                                                                                            },
                                                                                                            {
                                                                                                              src: "/productos/decent/agitador-tamiz-estandar/Imagen 3.png",
                                                                                                              alt: "Tamices estándar y conjunto de tapa y chasis",
                                                                                                            },
                                                                                                          ]
                                                                                                        : [];
      ...
      : product.slug === "thermo-trace-1600-series"
        ...
        : product.slug === "thermo-isq-em"
          ...
          : product.slug === "thermo-isq-ec"
            ? [
                {
                  src: "/productos/thermo-isq-ec/portada.png",
                  alt: "Espectrómetro de masa de cuadrupolo simple Thermo Scientific ISQ EC",
                },
                {
                  src: "/productos/thermo-isq-ec/integracion-dionex-integrion.png",
                  alt: "ISQ EC integrado a Dionex Integrion como referencia IC-MS",
                },
                {
                  src: "/productos/thermo-isq-ec/integracion-vanquish.png",
                  alt: "ISQ EC integrado a Vanquish como referencia LC-MS",
                },
              ]
      ...
      ? [
          {
            ...
            alt: "Horno de secado Decent de gran capacidad con gabinete de control",
          },
          {
            src: "/productos/decent/hornos-secado/imagen-2.png",
            alt: "Horno industrial de secado Decent con carros para bandejas",
          },
          {
            src: "/productos/decent/hornos-secado/imagen-3.png",
            alt: "Horno de secado Decent de convecciÃ³n forzada",
          },
          {
            src: "/productos/decent/hornos-secado/imagen-4.png",
            alt: "Horno compacto de secado Decent",
          },
          {
            src: "/productos/decent/hornos-secado/imagen-horizontal.png",
            alt: "Horno horizontal de secado Decent",
          },
        ]
      : galleryImages;
    ...
    <div className="min-h-dvh bg-[#F4F4F4]/70 text-[#101820]">
      ...
      <main id="main-content">
        ...
        <section className="relative w-full overflow-hidden bg-[#4A5560] pt-28 pb-16 md:pt-32 md:pb-20 lg:pt-40 lg:pb-24 text-center border-b border-[#D4DFDC]">
          ...
          {!useHanonLayout && (
            <div className="relative z-10 mx-auto mb-6 mt-8 max-w-[1600px] px-4 sm:mt-10 sm:px-6 lg:mt-12 lg:px-10">
          ...
          <section className="relative overflow-hidden bg-[#F5F5F7] py-16 lg:py-24 border-b border-[#D4DFDC]">
            ...
            <div className="relative z-10 mx-auto max-w-[1600px] px-4 sm:px-6 lg:px-10">
              <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
                ...
                <div className="flex flex-col justify-center text-[#101820] max-w-xl relative z-10 lg:pl-16">
                  <Reveal>
                    <nav
                      ...
                      className="mb-6 -translate-y-2"
                    >
                      <ol className="inline-flex min-w-0 flex-wrap items-center gap-1.5 text-[11.5px] font-semibold text-[#707E83]">
                        <li>
                          <Link
                            href="/"
                            className="hover:text-[#101820] transition-colors"
                          >
                            Inicio
                          </Link>
                        </li>
                        <li aria-hidden className="text-[#707E83]/60">
                          /
                        </li>
                        <li>
                          <Link
                        ...
                        <li>
                          <Link
                            href={`/productos?filtro=${encodeURIComponent(product.category)}`}
                            className="hover:text-[#101820] transition-colors"
                          >
                            {product.category}
                          </Link>
                    ...
                    {product.slug === "decent-hornos-secado" ? (
                      <h2 className="text-3xl font-black tracking-tight text-[#101820] sm:text-5xl lg:text-[54px] leading-[1.05] uppercase">
                        Hornos de Secado
                        <span className="block text-[#D6532B]">
                          Familia DDO / DDOG / DDOH(L)
                        </span>
                      </h2>
                    ) : null}
                    <h2
                      className={cn(
                        "text-3xl font-black tracking-tight text-[#101820] sm:text-5xl lg:text-[54px] leading-[1.05] uppercase",
                                            ...
                                            : product.slug ===
                                              ...
                                              : product.slug ===
                                                ...
                                                : product.slug ===
                                                  ...
                                                  : product.slug ===
                                                      "decent-mezclador-crisoles"
                                                    ? "Mezclador de Crisoles"
                                                    : product.slug ===
                                                        "decent-molino-pulverizador-dp1000"
                                                      ? "Molino Pulverizador"
                                                      : product.slug?.startsWith(
                                                            "decent-cargador-electrico",
                                                          )
                                                        ? "Cargador Eléctrico"
                                                        : product.slug?.startsWith(
                                                              "decent-cargador-manual",
                                                            )
                                                          ? "Cargador Manual"
                                                          : product.slug ===
                                                              "hanon-sox606"
                                    ...
                                    : product.slug === "decent-rodillo-botella"
                                      ...
                                      : product.slug === "decent-dsw350"
                                        ...
                                        : product.slug ===
                                          ...
                                          : product.slug ===
                                              "decent-copelas-magnesio"
                                            ? "Y Bloques de Lingotes"
                                            : product.slug ===
                                                "decent-dosificador-automatico-litargirio"
                                              ? "De Litargirio DAFS84"
                                              : product.slug ===
                                                  "decent-hornos-cupelacion"
                                                ? "DE50CF / DE100CF"
                                                : product.slug ===
                                                    "decent-horno-copelacion-alta-temperatura"
                                                  ? "Alta Temperatura 1500°C"
                                                  : product.slug ===
                                                      "decent-hornos-fusion-ensayo-fuego"
                                                    ? "DE20FF / DE25FF"
                                                    : product.slug ===
                ...
                <div className="relative w-full flex justify-center lg:justify-start min-h-[420px] lg:min-h-[540px] z-10">
                  <Reveal
                    delay={0.08}
                    className="w-full flex justify-center lg:justify-start"
                  >
                    <div className="relative w-full max-w-[420px] sm:max-w-[520px] lg:max-w-[620px] flex items-center justify-center">
                      {/* Static container */}
        ...
        {useHanonLayout ? null : (
          <section
            className={cn(
              "relative overflow-hidden pt-4 pb-6 md:pt-6 md:pb-8 lg:pt-8 lg:pb-12 text-white",
              heroBg,
            )}
          >
                ...
                <Reveal>
                  <div className="flex flex-col justify-center">
                    <p className="text-[12px] font-mono font-bold uppercase tracking-[0.22em] text-white/80 mb-2">
                      ...
                      {detail?.model ?? product.id}
                    </p>
                    <h2 className="max-w-[720px] text-[2rem] font-extrabold leading-[1.05] tracking-tight text-white sm:text-4xl lg:text-[34px]">
                    ...
                    <div className="mt-6 flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
                      <Button
                        asChild
                        className="bg-white hover:bg-white/90 text-[#101820] border-none rounded-full py-5 px-8 text-[12px] font-extrabold uppercase tracking-[0.16em] text-center justify-center shadow-md"
                      >
                        <Link
                          href={`/contacto/cotizar?producto=${product.slug ?? product.id}&from=${encodeURIComponent(`/productos/${product.slug ?? product.id}`)}`}
                        >
                ...
                <div className="bg-white border-y border-r border-l-4 border-[#D4DFDC] border-l-[#D6532B] rounded-r-[4px] p-6 md:py-8 md:px-10 flex flex-col md:flex-row items-center justify-between gap-8 max-w-5xl mx-auto shadow-sm">
                  <div className="flex flex-col justify-start w-full">
                    <h3 className="text-lg font-bold text-[#101820] tracking-tight">
                      ...
                      - {product.detail?.brand ?? "Del Carpio"}{" "}
                ...
                <div className="bg-[#F8FAFB] border border-[#D4DFDC] border-l-4 border-l-[#4A5560] rounded-r-[4px] p-6 md:py-8 md:px-10 flex flex-col md:flex-row items-center justify-between gap-8 max-w-5xl mx-auto shadow-sm">
                  <div className="flex flex-col justify-start">
                    <div className="inline-flex items-center gap-2 mb-1">
                      ...
                      <span className="text-[11px] font-mono font-bold uppercase tracking-[0.16em] text-[#707E83]">
                  ...
                  <Button
                    asChild
                    variant="secondary"
                    className="border-[#4A5560]/40 hover:bg-[#4A5560] hover:text-white rounded-full py-5 px-8 text-[12px] font-extrabold uppercase tracking-[0.16em] shrink-0 w-full md:w-auto text-center justify-center"
                  >
                    <Link
          ...
          <div className="relative z-10 mx-auto max-w-[1600px] px-4 sm:px-6 lg:px-10 flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="max-w-2xl">
              ...
              <h3 className="text-2xl font-extrabold tracking-tight text-[#F5F5F5] sm:text-3xl leading-tight">
                ¿Listo para evaluar el {detail?.model ?? product.name} en tu
                laboratorio?
              </h3>
