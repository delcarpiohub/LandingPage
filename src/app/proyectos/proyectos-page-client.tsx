...
const galleryProjects: CaseStudy[] = [
  {
    id: "laboratorio-modular",
    category: "Mobiliario técnico",
    title: "Laboratorio modular equipado",
    location: "Mesones, almacenamiento y superficies de trabajo",
    src: "/proyectos/gallery-laboratorio-modular.png",
    alt: "Laboratorio modular equipado con mesones, mobiliario técnico y superficies de trabajo",
  },
  {
    id: "mesones-almacenamiento",
    category: "Mobiliario técnico",
    title: "Mesones y almacenamiento de laboratorio",
    location: "Mobiliario interior para operación analítica",
    src: "/proyectos/gallery-mesones-almacenamiento.png",
    alt: "Mesones negros y módulos de almacenamiento instalados en un laboratorio",
  },
  {
    id: "redes-gases",
    category: "Infraestructura técnica",
    title: "Redes de gases para laboratorio",
    location: "Reguladores, distribución y puntos de uso",
    src: "/proyectos/gallery-redes-gases.png",
    alt: "Red de distribución de gases con reguladores instalada en un laboratorio",
  },
  {
    id: "laboratorio-operativo",
  ...
  },
  {
    ...
    title: "Laboratorio docente equipado",
